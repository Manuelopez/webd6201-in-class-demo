(function () {
  function AuthGuard(): void {
    let protectedRoutes: string[] = ['contact-list'];
  ...
  function ContactFormValidate(): void {
    ...
    ValidateInput(
      'fullName',
      fullNamePattern,
      'Please enter a valid Full name which means a capitalized first name and capitalized last name'
    );
    ValidateInput(
      'emailAddress',
      emailAddressPattern,
      ...
      $.get('./Data/users.json', function (data) {
        ...
        if (success) {
          ...
          messageArea
            ...
            .text(
              'Error: Invalid Login Credentials.. Username/Password Mismatch'
            )
            .show();
        }
      });
